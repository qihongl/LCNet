...
class PECRP:
    """
    03/06 a class used for PE-based CRP, adapted from anderson91
    ...
    def assign_to_prev(self, stim):
        assert len(stim) == self.context_dim, \
        f'context dim is {self.context_dim}, incompatible with the input with dim {len(stim)}'
        # use the previous cluster
